package cn.pqz.salary.config;

import cn.pqz.salary.component.security.*;
import cn.pqz.salary.component.security.smscode.SmsCodeSecurityConfig;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("**.jpeg","/smsCode","/login", "/verifyCode", "/uploadFile/**", "/test/**");
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/menuList").authenticated()//菜单列表仅需登录就能访问
